...
public class serv7 extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String strx=request.getParameter("serial_num");
...
//                Statement st=con.createStatement();
               // Statement st=con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
                ...
                javaclass1.st.executeUpdate("Insert into login  (serial_num,first_name,last_name,phone,email,pwd,cpwd,role) values ('"+strx+"','"+st1+"','"+st2+"','"+st3+"','"+st4+"','"+st5+"','"+st6+"','clerk')");                
               javaclass1.st.executeUpdate("Insert into signup  (serial_num,email,pwd,role) values ('"+strx+"','"+st4+"','"+st5+"','clerk')");
