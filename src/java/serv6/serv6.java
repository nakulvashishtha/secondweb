...
//                Statement st=con.createStatement();
               ...
               {                 
                javaclass1.st.executeUpdate("DELETE FROM vegetable WHERE serial_num='"+st1+"' ");
               }
               else if(st2.equalsIgnoreCase("fruit"))               
               {                
                javaclass1.st.executeUpdate("DELETE FROM fruit WHERE serial_num='"+st1+"' ");
               }
               else if(st2.equalsIgnoreCase("beauty product"))               
               {                
               javaclass1.st.executeUpdate("DELETE FROM beauty_p WHERE serial_num='"+st1+"' ");
               }
               else if(st2.equalsIgnoreCase("fertilizer"))               
               {                 
                javaclass1.st.executeUpdate("DELETE FROM fertilizer WHERE serial_num='"+st1+"' ");
               }
               else if(st2.equalsIgnoreCase("grain"))               
               {                
               javaclass1.st.executeUpdate("DELETE FROM grain WHERE serial_num='"+st1+"' ");
               }             
               else 
               {
