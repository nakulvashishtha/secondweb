...
public final class newjspfertilizer_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//                Statement st=con.createStatement();
               // Statement st=con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
                ResultSet rs=javaclass1.st.executeQuery("select * from fertilizer");
                    while(rs.next())
                    {
                        ...
                        str2 =rs.getString("name_fert");                     
                        str3=rs.getString("price_fert");
                        str4=rs.getString("details_fert");
      ...
      out.print( str4 );
      out.write(" </p>\n");
      out.write("              <input type=\"hidden\" name=\"type_product\" value=\"fertilizer\" />\n");
